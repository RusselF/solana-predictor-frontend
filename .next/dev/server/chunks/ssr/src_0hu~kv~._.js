...
"[project]/src/app/predict-date/page.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function PredictDatePage() {
    ...
    async function handleSubmit() {
        ...
        setResult(null);
        try {
            const r = await fetch(`${__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$config$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["API_URL"]}/predict_date?target_date=${date}`);
...
//# sourceMappingURL=src_0hu~kv~._.js.map